...
StarNet2 CLI를 Photoshop 안에서 실행하고 별 제거 결과를 레이어로 가져오는 Windows CEP 패널입니다.
...
Star Removal은 처리 시작 시 다음 순서로 결과 마스크를 결정합니다.
...
- 24시간 이상 지난 StarNet2 임시 파일은 패널 시작 시 정리합니다.
